...
def plot_loss_curve(out_path):
    record_path = os.path.join(out_path, 'record.pkl')

    with open(record_path, "rb") as f:
        record = pickle.load(f)
    if 'step_train_loss' in record:
        plt.plot(record['step_num'],record['step_test_loss'],label = 'Test Loss')
        plt.plot(record['step_num'],record['step_train_loss'],label = 'Train Loss')
        plt.xlabel('Step')
    elif 'epoch_train_loss' in record:
        plt.plot(record['epoch_test_loss'], label='Test Loss')
        plt.plot(record['epoch_train_loss'], label='Train Loss')
        plt.xlabel('Epoch')
